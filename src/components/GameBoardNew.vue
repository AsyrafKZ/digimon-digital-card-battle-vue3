    ...
    <div class="canvas-container">
        <div class="canvas-frame" ref="canvasFrameC">
            <TresCanvas clear-color="#183141" render-mode="on-demand">
                <Stats />
                <!-- <CustomCSS2DRenderer :width="width" :height="height" :canvasFrameC="canvasFrameC">
                </CustomCSS2DRenderer> -->
                    <OrbitControls />
